...
/**
 * Database Setup Script for Tobacco Tracker
...
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Ind1ZWJsdmtvdWtsb2lyaXN1b2p1Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2MjA3NTE1OSwiZXhwIjoyMDc3NjUxMTU5fQ.XuqvDELaakUVQbx-7uF4E7B7loaiQ7BZ-Tfmh7ogw9M';

const supabase = createClient(supabaseUrl, supabaseKey);

async function setupDatabase() {
  console.log('🚀 Starting Tobacco Tracker Database Setup...\n');
  ...
  try {
    ...
    console.log('\n🚀 Your application is now ready at: https://process-management-4t4o.onrender.com');
    console.log('   - Visit /farmers to see the sample farmers');
    console.log('   - Visit /purchases to see the sample purchases');
